...
def get_weather_data(country):
    try:
        ...
        response_geocoding = requests.get(f"http://api.openweathermap.org/geo/1.0/direct?q={country}&limit=5&appid=a4fa82eb10c9fd862bcdaf4edd3e4f35")
        ...
        return weather_status, temp, pressure, humidity, wind_speed
...
def display_weather_data():
    ...
    try:
        weather_status, temp, pressure, humidity, wind_speed = get_weather_data(country)
...
get_weather_button = ttk.Button(frame, text="Get Weather", command=display_weather_data)
